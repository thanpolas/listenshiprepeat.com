...
**Thanasis** [00.41.15]: Once you do a couple, then it becomes really a habit for you, it becomes very easy, I mean everything that I want to explain, I just pop out Quick time and start recording and convey my message entirely. That’s pretty much it. One last note here, is to have some kind of ritualisation like doker, but this is a very advanced topic and if you decide to go for it you would have all the better information by your hand so that doesn’t end as far as onboarding goes.
